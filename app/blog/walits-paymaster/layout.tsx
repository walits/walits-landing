...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://walits.com/blog/paymaster.png', width: 1200, height: 630, alt: 'Walits Gasless USDC EIP-3009 Relayer' }],
    type: 'article',
    siteName: 'Walits',
  },
  twitter: {
    ...
    images: ['https://walits.com/blog/paymaster.png'],
  },
};
