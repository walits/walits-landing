            ...
            <>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-lg my-6 border-l-4 border-red-500">
                ...
                <ul className="mb-0 space-y-2">
                  ...
                  <li><strong>트랜잭션 실패 후 가스비 환불 없음</strong> — 전송이 실패해도 가스비는 그냥 날아갑니다.</li>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        ...
                        이더리움 메인넷, Polygon, Arbitrum 등 주요 네트워크에 동일한 주소로 배포되어 있습니다.
...
[완료] 사용자는 ETH 한 푼도 없이 USDC 전송 성공`}
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg my-8 border-l-4 border-blue-500">
                ...
                <p className="mb-0">
                  하지만 <strong>2026년 현실</strong>은 다릅니다. 일일 USDC 전송량은 수십억 달러에 달하고,
                  ETH 전송량의 수십 배입니다. USDC가 이미 "실제 돈"의 역할을 하고 있어요.
...
✅ 60 USDC 수령 완료`}
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 rounded-lg my-6 border-l-4 border-blue-500">
                <p className="font-semibold mb-3 text-blue-900 dark:text-blue-300">Walits의 ERC-4337 구현 포인트</p>
                <ul className="space-y-2 mb-0">
                  <li><strong>Paymaster 운영</strong> — USDC로 가스비를 낼 수 있도록 자체 Paymaster 컨트랙트 운영</li>
                  <li><strong>MPC + 스마트 계정</strong> — MPC 키 관리 위에 ERC-4337 스마트 계정을 결합하여 보안과 UX 모두 해결</li>
                  <li><strong>배치 트랜잭션</strong> — 정산, 재투자 등 여러 작업을 묶어 한번에 처리</li>
                  <li><strong>세션 키</strong> — 반복 결제 시 매번 서명 불필요</li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-xl my-12 text-center">
                <h3 className="text-2xl font-bold mb-4">스테이블코인 실사용 시대, Walits와 함께</h3>
                <p className="mb-6">
                  ETH 없이, 복잡한 주소 없이. USDC를 진짜 돈처럼 쓰는 지갑.
                </p>
                <Link
                  href="/inquiry"
            ...
            <>
              ...
              <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-lg my-6 border-l-4 border-red-500">
                ...
                <ul className="mb-0 space-y-2">
                  ...
                  <li><strong>No gas refund on failed transactions</strong> — Even if a transfer fails, gas fees are gone.</li>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        ...
                        submitted by the bundler. Deployed at the same address across Ethereum mainnet, Polygon,
                        Arbitrum, and other major networks.
...
[Done] User successfully sent USDC with zero ETH`}
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg my-8 border-l-4 border-blue-500">
                ...
                <p className="mb-0">
                  But the <strong>reality of 2026</strong> is different. Daily USDC transaction volume is in the tens of billions,
                  dwarfing ETH transfer volume. USDC is already acting as "real money."
...
✅ 60 USDC received`}
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 rounded-lg my-6 border-l-4 border-blue-500">
                <p className="font-semibold mb-3 text-blue-900 dark:text-blue-300">Walits ERC-4337 Implementation</p>
                <ul className="space-y-2 mb-0">
                  <li><strong>Paymaster operation</strong> — Own Paymaster contract enabling USDC-based gas payment</li>
                  <li><strong>MPC + Smart Account</strong> — MPC key management combined with ERC-4337 smart accounts for both security and UX</li>
                  <li><strong>Batch transactions</strong> — Bundle settlement, reinvestment and other actions into a single operation</li>
                  <li><strong>Session keys</strong> — No repeated signatures for recurring payments</li>
                </ul>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-xl my-12 text-center">
                <h3 className="text-2xl font-bold mb-4">The Stablecoin Era Is Here — Join Walits</h3>
                <p className="mb-6">
                  No ETH required. No complex addresses. USDC as real money.
                </p>
                <Link
                  href="/inquiry"
                  className="inline-block px-8 py-4 bg-white text-blue-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
